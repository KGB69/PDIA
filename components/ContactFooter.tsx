            ...
            <div className="md:col-span-2">
                ...
                <div className="grid sm:grid-cols-3 gap-8">
                    <div className="flex flex-col items-center">
                        ...
                        <a href={`mailto:${CONTACT_INFO.email}`} className="text-gray-300 hover:text-pdi-red transition-colors">{CONTACT_INFO.email}</a>
                    </div>
                    <div className="flex flex-col items-center">
                        <img src="/icons/phone.svg" className="w-8 h-8 mb-3" alt="Phone" />
                        <h4 className="font-semibold">Phone</h4>
                        <a href={`tel:${CONTACT_INFO.phone}`} className="text-gray-300 hover:text-pdi-red transition-colors">{CONTACT_INFO.phone}</a>
                    </div>
                    <div className="flex flex-col items-center">
